...
export type AppViewState = {
  ...
  carepilotSection: CarePilotSection;
  carepilotOnboardingStep: number;
  carepilotOnboardingDraft: CarePilotProfileDraft;
  carepilotLastReceipt: CarePilotPrivacyReceipt | null;
  carepilotRecording: boolean;
  carepilotAudioPreviewUrl: string | null;
  carepilotCapturedAudioUri: string | null;
  ...
  loadCarePilot: () => Promise<void>;
  saveCarePilotProfile: (draft: CarePilotProfileDraft) => Promise<boolean>;
  runCarePilotPrivacyAction: (action: "export" | "delete") => Promise<boolean>;
  startCarePilotRecording: () => Promise<boolean>;
  stopCarePilotRecording: () => void;
  transcribeCarePilotRecording: () => Promise<boolean>;
