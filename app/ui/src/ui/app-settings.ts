...
export async function refreshActiveTab(host: SettingsHost) {
  ...
  if (host.tab === "carepilot") {
    const app = host as unknown as OpenClawApp;
    await app.loadCarePilot();
    await refreshChat(app as unknown as Parameters<typeof refreshChat>[0]);
    scheduleChatScroll(app as unknown as Parameters<typeof scheduleChatScroll>[0], true);
  }
  if (host.tab === "config") {
