...
describe("iconForTab", () => {
  ...
  it("returns stable icons for known tabs", () => {
    ...
    expect(iconForTab("carepilot")).toBe("heartPulse");
...
describe("titleForTab", () => {
  ...
  it("returns expected titles", () => {
    ...
    expect(titleForTab("carepilot")).toBe("CarePilot");
...
describe("subtitleForTab", () => {
  ...
  it("returns descriptive subtitles", () => {
    ...
    expect(subtitleForTab("carepilot")).toContain("health dashboard");
...
describe("pathForTab", () => {
  it("returns correct path without base", () => {
    ...
    expect(pathForTab("carepilot")).toBe("/carepilot");
...
describe("tabFromPath", () => {
  it("returns tab for valid path", () => {
    ...
    expect(tabFromPath("/carepilot")).toBe("carepilot");
...
describe("inferBasePathFromPathname", () => {
  ...
  it("returns empty string for direct tab path", () => {
    ...
    expect(inferBasePathFromPathname("/carepilot")).toBe("");
